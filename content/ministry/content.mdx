...
<MinistryContainer>
  <Ministry name="Weekly Fellowship Meetings" image="/images/ministry/group.jpg" description="The main fellowship meeting for ACF. We meet every Wednesday from 5:00pm-7:00pm. Rooms TBA." />

  <Ministry
    name="Prayer Meetings"
    image="/images/ministry/prayer.jpg"
...
"
  ...
  <Ministry
    name="Small Groups"
    image="/images/ministry/small_groups.jpg"
...
Contact Ethan for more details.
"
  />
...
JAW dates are still TBD for the 2025-2026 school year, stay tuned!
"
  />

  <Ministry
    name="Study Sessions & Devos"
    image="/images/ministry/devos.jpg"
    description="Come join us as we spend time studying together. At the end of every study session, Julian will also be leading a short bible study or devo.

Contact any comm member for more details."
  />

  <Ministry
    name="ACF Gym"
    image="/images/ministry/gym.jpg"
    description="Weekly gym sessions for ACF!

Contact Ethan for more!"
  />
</MinistryContainer>
